...
EXTRA="--no-ancient-blocks --warp-barrier=30000"  
PARAMS="$CONFIG $EXTRA" 
...
echo $PARAMS
$OE --identity=node4 --base-path=node4 --port=30306 --unlock=0xcfa3ae1840e38d1e54b0ef6300d6e91b22964a75 $PARAMS -l "sync=debug" 2>&1 |(sed 's/^/[1] /') &
NODE4PID=$!
